...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">fill your information for any query.</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-green-500" href="https://gppune.ac.in">www.gpp.ac.in</a>
          <p class="leading-normal my-5">Goverment Polytechnic Pune.
            <br>Shivajinagar.
          </p>
